...
function analyzeColor(color) {
    ...
    switch (color) {
        case "blue":
            msg = "blue is the color of the sky";
            break;
        case "red":
            msg = "Strawberries are red";
            break;
        default:
            msg = `I don't know anything about ${color}`;
    }
    return msg;
}
...
const userColor = prompt("Name a color");
...
Your price before the discount was $${amountDue}.
Your price after the discount is $${discountedPrice}; a ${discountPercent}% discount.
`);
